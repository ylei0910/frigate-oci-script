...
echo ""
echo "Note: If Frigate fails to start or web UI is unreachable, check logs using:"
echo "      pct exec $CT_ID -- tail -f /dev/stdout"
echo "      or get container shell via: pct enter $CT_ID"
echo ""
